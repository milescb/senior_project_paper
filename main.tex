...
\begin{equation}
    ...
    \end{split}
\end{equation}
for $0 < x < 1$ and $t > 0$. This system is a simplification of the Navier-Stokes equations solved by (\textbf{ADD RESOURCE + DESCRIPTION}) We employ the following initial condition
